package com.shopfreelancer.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.shopfreelancer.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.shopfreelancer.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.shopfreelancer.domain.User.class.getName());
            createCache(cm, com.shopfreelancer.domain.Authority.class.getName());
